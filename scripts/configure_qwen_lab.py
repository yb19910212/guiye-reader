...
objects = '''
        EE000000000000000000000A = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = OfflineModelFiles.swift; sourceTree = "<group>"; };
        EE000000000000000000000B = {isa = PBXBuildFile; fileRef = EE000000000000000000000A; };
...
text = text.replace('path = GuiyeReader; sourceTree = "<group>"; children = (',
                    'path = GuiyeReader; sourceTree = "<group>"; children = (EE000000000000000000000A,EE0000000000000000000001,EE0000000000000000000003,EE0000000000000000000005,')
for phase, entry in [('PBXSourcesBuildPhase', 'EE000000000000000000000B,EE0000000000000000000002'),
...
text = text.replace('CURRENT_PROJECT_VERSION = 21;', 'CURRENT_PROJECT_VERSION = 24;')
text = text.replace('MARKETING_VERSION = 0.16.0;', 'MARKETING_VERSION = 0.17.2;')
